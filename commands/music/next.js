...
module.exports.callback = async (client, interaction, options) => {
    ...
    if (index > 0) {
        ...
        }else return embedReply(interaction, getEmbed(":x: I don't found song with this index !", process.env.RED), false, true);
    }
    ...
    if (!music.queue[0]) {
        ...
        return embedReply(interaction, getEmbed("🙁 I don't have queue !", getBotColor(client, interaction.guildId)), false, true);
    } else {
